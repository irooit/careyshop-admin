...
export default {
  ...
  render(h) {
    return <div
      flex='cross:center'
      class={ { 'cs-theme-header-menu': true, 'is-scrollable': this.isScroll } }
      ref='page'>
      <div
        ref='content'
        class='cs-theme-header-menu__content'
        flex-box='1'
        flex>
        <div
          class='cs-theme-header-menu__scroll'
          flex-box='0'
      ...
      </div>
      {
        this.isScroll
          ? [
            <div
              class='cs-theme-header-menu__prev'
            ...
            <div
              class='cs-theme-header-menu__next'
              flex='main:center cross:center'
              flex-box='0'
