<template>
  <el-form
    ...
    <el-form-item label="退款方式" prop="to_payment">
      <el-select
    ...
    <el-form-item>
      <el-popover
        ...
        <div class="more-filter">
          ...
          <el-form-item label="退款流水号" prop="refund_no">
            <el-input
              v-model="form.refund_no"
              prefix-icon="el-icon-search"
              placeholder="可输入退款流水号"
              @keyup.enter.native="handleFormSubmit(true)"
              :clearable="true"/>
          </el-form-item>

          <el-form-item label="退款交易号" prop="out_trade_no">
            <el-input
              v-model="form.out_trade_no"
              prefix-icon="el-icon-search"
              placeholder="可输入退款交易号"
              @keyup.enter.native="handleFormSubmit(true)"
              :clearable="true"/>
          </el-form-item>
        </div>
